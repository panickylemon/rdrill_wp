    ...
    <div class="l-container">
        ...
        <div class="filter-sidebar">
            <div class="filter-catalog" id="filter-form">
                <?php
                echo do_shortcode( '[woof tax_only="product_cat" autohide=0 autosubmit=0
                    taxonomies=product_cat:10]' );
                ?>
            </div>
        ...
        <?php if (have_posts()) : ?>
            <div class="filter-content">
                <div class="catalog-products-wrap clearfix">
                    <?php
                    echo do_shortcode( '[woof_products per_page=12 columns=3 is_ajax=1 taxonomies=product_cat:10]' );
                    ?>
                </div>
