...
<div class="catalog catalog-drill">
    ...
    <div class="l-container">
        <?php
        echo do_shortcode( '[woof sid="auto_shortcode" tax_only="product_cat,pa_ves" autohide=0 autosubmit=0 taxonomies=product_cat:10 ]' );
        ?>
        <?php dynamic_sidebar( 'sidebar-1' ); ?>

        <?php

        echo do_shortcode( '[woof_products per_page=8 columns=3 is_ajax=1 taxonomies=product_cat:10]' );
        ?>
