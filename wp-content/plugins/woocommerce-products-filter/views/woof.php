...
if (!function_exists('woof_print_tax'))
{
    ...
    function woof_print_tax($taxonomies, $tax_slug, $terms, $exclude_tax_key, $taxonomies_info, $additional_taxes, $woof_settings, $args, $counter)
    {
        ...
        ?>
        <div data-css-class="woof_container_<?php echo $tax_slug ?>" class="filter-item woof_container_<?php echo
        $woof_settings['tax_type'][$tax_slug] ?> woof_container_<?php echo $tax_slug ?> woof_container_<?php echo $counter ?> woof_container_<?php echo $primax_class ?>">
                        ...
                        <div class="filter-buttons clearfix">
                            ...
                            <?php if (!$autosubmit OR $ajax_redraw): global $woof_link; ?>
		                        ...
		                        <button class="base-button base-button--grey button-filter button-filter-reset" data-link="<?php echo
		                                    $woof_link ?>"><a href="<?php echo
		                                    $woof_link ?>">Сбросить</a></button>
		                    <?php endif; ?>
                        </div>
