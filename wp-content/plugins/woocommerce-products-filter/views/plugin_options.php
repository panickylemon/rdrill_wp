...
<table style="width: 100%;">
    <tr>
        <td style="width: 30%;">
            ...
            <a href="http://www.woocommerce-filter.com/a/buy" target="_blank"><img src="<?php echo WOOF_LINK ?>img/woof_banner.png" alt="<?php _e("full version of the plugin", 'woocommerce-currency-switcher'); ?>" /></a>
        </td>
        <td style="width: 10%;">
        ...
        <td style="width: 50%;">
            <h3><?php _e("Get WooCommerce Currency Swither", 'woocommerce-currency-switcher') ?>:</h3>
            <a href="http://currency-switcher.com/a/buy" target="_blank"><img src="<?php echo WOOF_LINK ?>img/woocs_banner.jpg" alt="<?php _e("WOOCS", 'woocommerce-currency-switcher'); ?>" /></a>
        </td>
    </tr>
