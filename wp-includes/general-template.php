...
href="' . esc_url( apply_filters( 'paginate_links', $link ) ) .
	...
	for ( $n = 1; $n <= $total; $n++ ) :
		if ( $n == $current ) :
			$page_links[] = "<li class='active'><span>" . $args['before_page_number'] . number_format_i18n( $n ) . $args['after_page_number'] . "</span></li>";
			$dots = true;
		else :
			...
			elseif ( $dots && ! $args['show_all'] ) :
				$page_links[] = '<li class="dots"><span class="page-numbers dots">' . __( '&hellip;' ) . '</span></li>';
				$dots = false;
			endif;
		endif;
	endfor;
